  ...
  return (
    ...
    >
      ...
      <nav aria-label="Decision navigation" className="mt-6 flex flex-col-reverse gap-3 border-t border-border pt-5 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button type="button" disabled className="inline-flex h-12 cursor-not-allowed items-center justify-center gap-2 rounded-lg border border-border bg-slate-100 px-5 font-semibold text-muted" title="Workforce Decision is not available yet">Workforce coming next<ArrowRight size={18} /></button>
      </nav>
    </StudentPage>
  );
}
